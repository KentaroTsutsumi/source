program ksf_bin2txt
  ...
  do iq = iniq, lasq
    !
    write(fname,*) iq
    write(fname1,*) "vc", trim(adjustl(fname)), "_2.dat"
    write(fname2,*) "vc", trim(adjustl(fname)), "_2.txt"
    write(fname3,*) "Ksf", trim(adjustl(fname)), "_2.dat"
    write(fname4,*) "Ksf", trim(adjustl(fname)), "_2.txt"
